...
- `sediment/` — ✅ 部分实现：checkpoint/run-window + project-only writer substrate（validate/sanitize/dedupe/lint/lock/atomic write/audit/git best-effort）；自动 extract 仍计划中
