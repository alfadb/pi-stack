...
> **状态**：In progress（2026-05-10；Phase 0/1 implemented；Phase 2 curator create/update/skip subset implemented by ADR 0016，merge/archive/delete pending）
...
| **Phase 2** | sediment curator 接入新 search：优先 update/merge，create 次之（ADR 0010 lookup-tools loop + ADR 0016） | 🟡 create/update/skip subset implemented；merge/archive/delete pending | Phase 1 burn-in 1-2 天 |
