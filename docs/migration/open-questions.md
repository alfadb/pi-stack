...
- **Q1 旧 .pensieve 迁移** → ✅ **已解决**：`apply-checklist.md` 记 "Phase 1 migration completed (2026-05-08)"，­~/.pi 父仓 173 → 0 pending（由 14 batch 完成）。迁移工具为 `extensions/sediment/migration.ts` + `/sediment migrate-one --plan/--apply --yes/--restore`。
